...
// com RT_TABLES do index.html. Roda depois de mexer no Realtime (e vale como passo de CI).
//
...
// ambiente: usa a URL e a anon key que já estão públicas no index.html, e uma função RPC
...
console.error('✗ DRIFT entre RT_TABLES (index.html) e a publicação supabase_realtime do banco:');

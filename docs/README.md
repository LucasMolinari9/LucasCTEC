...
- [`historico/`](historico/) é **arquivo frio**: snapshots, auditorias e handoffs datados. Ele
  preserva evidência, mas não é fonte vigente e não faz parte do contexto normal de uma sessão.
